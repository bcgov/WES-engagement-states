tagList(
  tags$p("The Work Environment Survey (WES) was in the field from October 6, 2015 through October 30, 2015."),
  tags$p("Do you have a question about WES? You have come to the right page."),
  tags$p("Our philosophy about questions is simple:"),
  tags$ul(
