...
<table>
  <tbody>
    <tr>
    <td>Study</td>
    <td>BC Public Service Work Environment Survey (WES) 2015</td>
    </tr>
    
    <tr>
    <td>Project Sponsor</td>
    <td>BC Public Service Agency</td>
    </tr>
    </tbody>
    </table>
    '
...
<table>
  <tbody>
    <tr>
    <td>Modes</td>
    <td>Online and Post Mail Questionnaire</td>
    </tr>
    
    <tr>
    <td>Fielding Window / Dates</td>
    <td>October 6 - October 30, 2015</td>
    </tr>
    
    <tr>
    <td>Project History</td>
    <td>Annual survey 2006-2011; Biennial survey 2013, 2015</td>
    </tr>
    </tbody>
    </table>
    '
  ),
  h2("Population/Sample"),
  HTML(
    '
<table>
  <tbody>
    <tr>
    <td>Scope</td>
    <td>Individuals who were deemed as active BC Public Service employees in the Corporate Human Resource Information and Payroll System (CHIPS) as of September 15, 2015 (and remained active through to the survey launch date of October 6, 2015) and had valid contact information.</td>
    </tr>
