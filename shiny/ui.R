    ...
    tabsetPanel(
      ...
      tabPanel(
        ...
        div(
          ...
          br(),
          p("What characterizes these changes? Four types of migration describe the changes in the overall count and percentage of employees in each state from 2013 to 2015: "),
          br(),
          strong("1. Changes in continuing respondents: "),
          p("perceptions of those who answered in both 2013 & 2015"),
          br(),
          strong("2. Changes in BC Public Service population: "),
          p("employees hired into the BC Public Service since 2013 or departed from the BC Public Service after 2013"),
          br(),
          strong("3. Changes in organization population: "),
          p("employees who transferred from another organization into the reference organization since 2013 or transferred out of the reference organization and into another organization after 2015"),
          br(),
          strong("4. Changes in sample: "),
          p(" single-year respondents (answered in 2013 or 2015)."),
