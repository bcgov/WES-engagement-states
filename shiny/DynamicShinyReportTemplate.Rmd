...
WES_data <- read_csv("data/finalMockData.csv", 
...
if (!params$Organization %in% unique(WES_data$ORGID15)) {
  stop(paste0("The organization you provided is not in the data: ",
              params$Organization))
}

WES_data$ENGSTATE13 <- recode(WES_data$ENGSTATE13,"c('Engaged','Moderately Engaged')='Engaged'")
WES_data$ENGSTATE15 <- recode(WES_data$ENGSTATE15,"c('Engaged','Moderately Engaged')='Engaged'")

WES_data$ENGSTATE13 <- recode(WES_data$ENGSTATE13,"c('Disengaged','Minimally Engaged')='Disengaged'")
WES_data$ENGSTATE15 <- recode(WES_data$ENGSTATE15,"c('Disengaged','Minimally Engaged')='Disengaged'")
